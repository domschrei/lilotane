...
USignature::USignature(int nameId, const std::basic_string<int> &args) : _name_id(nameId), _args(args) {}
USignature::USignature(int nameId, std::basic_string<int> &&args) : _name_id(nameId), _args(std::move(args)) {}
...
Signature::Signature(int nameId, const std::basic_string<int> &args, bool negated) : _usig(nameId, args), _negated(negated) {}
Signature::Signature(int nameId, std::basic_string<int> &&args, bool negated) : _usig(nameId, std::move(args)), _negated(negated) {}
