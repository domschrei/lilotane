...
Action::Action(int nameId, const std::basic_string<int> &args) : HtnOp(nameId, args) {}
Action::Action(int nameId, std::basic_string<int> &&args) : HtnOp(nameId, std::move(args)) {}
