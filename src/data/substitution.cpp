...
Substitution::Substitution(const std::basic_string<int> &src, const std::basic_string<int> &dest)
{
...
std::vector<Substitution> Substitution::getAll(const std::basic_string<int> &src, const std::basic_string<int> &dest)
{
