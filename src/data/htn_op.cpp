...
HtnOp::HtnOp() {}
HtnOp::HtnOp(int id, const std::basic_string<int> &args) : _id(id), _args(args) {}
HtnOp::HtnOp(int id, std::basic_string<int> &&args) : _id(id), _args(std::move(args)) {}
...
const std::basic_string<int> &HtnOp::getArguments() const
{
    return _args;
}
